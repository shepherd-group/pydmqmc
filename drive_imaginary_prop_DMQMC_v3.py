...
# Data Saving
data = []
csvname = '5x5exactspace-propI-1jtauH-tau^2H^2'
#csvname = 'adaptive-dmqmc-semistochastic-stochastic-rounding-propV2-tau0.1'
#csvname = 'adaptive-dmqmc-semistochastic-stochastic-rounding-propV2-without50'
#csvname = 'adaptive-dmqmc-semistochastic-stochastic-rounding-tobeta3-propV2'
    ...
    for report in range(reports):
        ...
        for cycle in range(cycles):
            ...
            if round(iteration*tau,4) > 3.0:
                ...
                ##P11
                #delta_rho_1 = -H[:det_space, :det_space] @ rho[:det_space, :] * tau 
                ##P22
                #delta_rho_2 = -H[det_space:, det_space:] @ rho[det_space:, :] * tau
                ##P12
                #delta_rho_3 = -H[:det_space, det_space:] @ rho[det_space:, :] * tau
                ##P21
                #delta_rho_4 = -H[det_space:, :det_space] @ rho[:det_space, :] * tau
                #d[:det_space, :] += delta_rho_1 
                #d[det_space:, :] += delta_rho_2
                #d[:det_space, :] += delta_rho_3
                #d[det_space:, :] += delta_rho_4
